              ...
              <div className="col-md-8">
                <div className="cs-content">
                  <h1 className="bd-title">
                    Welcome to the FindHusly Terms &amp; conditions
                  </h1>
                  <p className="bd-lead">
                  ...
                  <ul className="list-checked mb-9 mb-md-10">
                    <li>
                      Donec ultricies purus sed augue tempus, sed porttitor
                      libero faucibus.
                    </li>
                    <li>
                  ...
                  <p>
                    ...
                    including versions of Lorem Ipsum. All the Lorem Ipsum
                    ...
                    combined with a handful of mode
                  </p>
                  ...
                  <p>
                    ...
                    200 Latin words, combined with a handful of mode
                  </p>
